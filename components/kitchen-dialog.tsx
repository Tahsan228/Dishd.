...
export function KitchenDialog({
  ...
  return (
    <dialog
      ...
      aria-labelledby="kitchen-dialog-title"
      onClose={onClose}
      onClick={(event) => {
        ...
        <>
          ...
          <div className="dialog-content">
            <div className="dialog-heading">
              <div>
                <p className="eyebrow">Welcome to {kitchen.cook}’s table</p>
                <h2 id="kitchen-dialog-title">{kitchen.name}</h2>
              </div>
              <button
              ...
              >
                ...
                {saved ? "Saved" : "Save kitchen"}
              </button>
            </div>
            <div className="dialog-meta">
              <span>
                <MapPin size={14} />
                {kitchen.neighborhood}, {kitchen.city}
              </span>
              <span>
                <Star size={14} fill="currentColor" />
                {(kitchen.rating10 / 2).toFixed(1)} · {kitchen.reviews} reviews
              </span>
              <span>
                <Clock3 size={14} />
                {kitchen.pickup}
            ...
            <div className="source-note">
              <Leaf size={17} />
              <p>
                Halal at heart. Made in small batches, with care for the
                ingredients and the people around the table. This sample kitchen
                has no verified sourcing record.
              </p>
            </div>
            <div className="dialog-menu-heading">
              <h3>A little taste of the menu</h3>
            ...
            <p className="demo-note">
              Sample kitchen · Browsing preview only. No real orders or
              payments.
            </p>
          </div>
        </>
